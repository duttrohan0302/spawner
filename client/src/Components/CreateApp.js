...
const CreateApp = (props) => {
    ...
    const addModel = (e) => {
        e.preventDefault();
            setSignUpForm({
                ...signUpForm,
                appSchema: [...signUpForm.appSchema,{
                    name: "",
                    attributes:[]
                }]
            })
    ...
    const addAttribute = (e,name) => {
        ...
        const elementsIndex = signUpForm.appSchema.findIndex(model => model.name === name )
        let newArray = [...signUpForm.appSchema]
        newArray[elementsIndex].attributes = [...newArray[elementsIndex].attributes,{
            name:"",
            type:"",
            ref:"",
            required:""
    ...
    return (
        <div style={{ backgroundColor: '#B23CFD', padding:"20px", height:"100vh"}}>
            <div className="display-2">
                <center>Continue creating your application...</center>
            </div>
            <div className="container-fluid" style={{ paddingLeft: '50px', paddingRight: "50px", marginTop:'20px',overflowY:'auto'}}>
                <div className="row">
                    <div className="col-md-12" style={{ backgroundColor: '#00B74A', borderTopLeftRadius: '20px', borderBottomLeftRadius: '20px',padding:"20px"}}>
                        ...
                        <div className="signup-form">
                            <Form>
                                ...
                                <div>
                                    {
                                        signUpForm.appSchema && signUpForm.appSchema.map((model,modelIndex)=>(
                                            <div>
